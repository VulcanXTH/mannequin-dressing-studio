...
echo [1/4] ปิดโปรแกรม + ตัวติดตั้งเก่าที่ค้าง (Closing app ^& stale setups)...
taskkill /F /T /IM "Mannequin Dressing Studio.exe" >nul 2>&1
rem ปิดทุก process ที่ชื่อขึ้นต้นด้วย Mannequin (รวมตัว Setup เก่าที่ค้างจากการกดครั้งก่อน)
rem ตัวติดตั้ง NSIS จะนับ process ชื่อคล้ายกันว่าเป็น "แอปกำลังรัน" ทำให้ขึ้น cannot be closed
